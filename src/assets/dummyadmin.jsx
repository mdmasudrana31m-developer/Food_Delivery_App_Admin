...
export const styles = {
  pageWrapper:
    "min-h-screen bg-gradient-to-br from-[#1a120b] via-[#2a1e14] to-[#3e2b1d] py-12 px-4 sm:px-6 lg:px-8",
  cardContainer:
    "bg-[#4b3b3b]/80 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border-2 border-amber-500/20",
  title:
    "text-3xl font-bold mb-8 bg-gradient-to-r from-amber-300 to-amber-500 bg-clip-text text-transparent text-center",
  ...
  // AddItems styles
  formWrapper:
    "min-h-screen bg-gradient-to-br from-[#1a120b] via-[#2a1e14] to-[#3e2b1d] py-10 px-4 sm:px-6 lg:px-8",
  formCard:
    "bg-[#4b3b3b]/80 backdrop-blur-sm rounded-3xl p-6 sm:p-8 shadow-2xl border-2 border-amber-500/20",
  formTitle:
    "text-2xl sm:text-3xl font-bold mb-6 sm:mb-8 bg-gradient-to-r from-amber-300 to-amber-500 bg-clip-text text-transparent text-center",
  uploadWrapper: "flex justify-center",
  uploadLabel:
    "w-full max-w-xs sm:w-72 h-56 sm:h-72 bg-[#3a2b2b]/50 border-2 border-dashed border-amber-500/30 rounded-2xl cursor-pointer flex items-center justify-center overflow-hidden hover:border-amber-400 transition-all",
  ...
  inputField:
    "w-full bg-[#3a2b2b]/50 border border-amber-500/20 rounded-xl px-4 py-3 sm:px-5 sm:py-4 focus:outline-none focus:border-amber-400 text-amber-100",
  ...
  // AdminNavbar styles
  navWrapper:
    "bg-[#2D1B0E] border-b-8 border-amber-900/40 shadow-lg sticky top-0 z-50 font-vibes",
  ...
  navLinkInactive:
    "border-amber-900/30 text-amber-100 hover:border-amber-500 hover:bg-amber-900/20",
